...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.referralcompletes.store']]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('patient_name', trans('quickadmin.referralcomplete.fields.patient-name').'', ['class' => 'control-label']) !!}
