...
@section('content')
    ...
    {!! Form::model($sms_import, ['method' => 'PUT', 'route' => ['admin.sms_imports.update', $sms_import->id]]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('source', trans('quickadmin.sms-import.fields.source').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('message', trans('quickadmin.sms-import.fields.message').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('intimation_date_time', trans('quickadmin.sms-import.fields.intimation-date-time').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('patient_name', trans('quickadmin.sms-import.fields.patient-name').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('referrer_name', trans('quickadmin.sms-import.fields.referrer-name').'', ['class' => 'control-label']) !!}
