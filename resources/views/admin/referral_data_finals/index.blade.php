    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            window.dtDefaultOptions.columns = [@can('referral_data_final_delete')
                ...
                {data: 'ip.total_bill_amount', name: 'ip.total_bill_amount'},
                //{data: 'tcs_tax', name: 'tcs_tax'},
                {data: 'ip.discount_amount', name: 'ip.discount_amount'},
                //{data: 'doctor_name', name: 'doctor_name'},
                //{data: 'speciality', name: 'speciality'},
                {data: 'ip.surgical_package_name', name: 'ip.surgical_package_name'},
                {data: 'ip.total_pharmacy_amount', name: 'ip.total_pharmacy_amount'},
                ...
                {data: 'message.channel', name: 'message.channel'},
                {data: 'message.message', name: 'message.message'},
                //{data: 'patient_name', name: 'patient_name'},
                //{data: 'referrer_name', name: 'referrer_name'},
                //{data: 'uhid', name: 'uhid'},
                {data: 'patient.city', name: 'patient.city'},
                {data: 'patient.country', name: 'patient.country'},
                ...
                {data: 'avip.rate_details', name: 'avip.rate_details'},
