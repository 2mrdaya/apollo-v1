...
class VenderpaymentsController extends Controller
{
    ...
    public function getQuaterlyComparison($period)
    {
        ...
        group by vendor, name, avip_id, vendors.oracle_code order by vendors.vendor,vendors.oracle_code";
        ...
        for ($i = 0; $i < count($query1); $i++) {
            ...
            $export_data.=$query1[$i]->oracle_code.','.$query1[$i]->name.','.$query1[$i]->vendor.",";
