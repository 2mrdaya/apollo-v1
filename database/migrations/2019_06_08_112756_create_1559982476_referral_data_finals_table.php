...
class Create1559982476ReferralDataFinalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if(! Schema::hasTable('referral_data_finals')) {
            Schema::create('referral_data_finals', function (Blueprint $table) {
                $table->increments('id');
    ...
    {
        Schema::dropIfExists('referral_data_finals');
    }
}
